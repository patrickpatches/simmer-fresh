...
| `docs/prototypes/hone.html` | Original full-app HTML prototype (pre-React Native). |
| `docs/prototypes/pantry-redesign.html` | Pantry screen redesign mockup. |
| `docs/prototypes/mise.html` | Mise en place / prep screen concept. |
| `docs/prototypes/old-index.html` | Early PWA index copy (superseded by root index.html). |
...
- **No files in repo root** except: CLAUDE.md, BUGS.md, CHANGELOG.md, README.md, index.html (PWA), and the four standard hidden dirs (.git, .github, .claude, .gitignore)
...
- AI-generated food photography — real photos only per Golden Rule 5
